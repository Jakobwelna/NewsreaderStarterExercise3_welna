...
//In cooperation with Matthias Werkl
...
public class Controller {
	...
	public void analyze3(List<Article> a){
		Article shortestNames = a.stream().filter(article -> article.getAuthor() != null).min(Comparator.comparing(article -> article.getAuthor().length())).orElse(new Article());
		System.out.println(shortestNames.getAuthor());
	}
